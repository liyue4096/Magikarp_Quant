...
# Historical backfill script: 2005-2009 (Monthly with cooldown)
# 
# Strategy:
...
#
# Usage: ./scripts/backfill-2005-2009-monthly.sh [environment]
...
echo "=========================================="
echo "Historical Backfill: 2005-2009 (Monthly)"
...
# Process all months from 2005-2009
# We'll process 5 months at a time (one per API key), then wait 60s

month_counter=0
total_months=60

for year in 2005 2006 2007 2008 2009; do
