...
# Historical backfill script: 2000-2004 (Monthly with cooldown)
# 
# Strategy:
# - Process 1 month at a time per API key
# - 5 API keys process 5 months in parallel
# - After each month completes, wait 60s before next month with same API key
# - This respects FRED's 120 req/min rate limit
#
# Usage: ./scripts/backfill-2000-2004-monthly.sh [environment]
...
echo "=========================================="
echo "Historical Backfill: 2000-2004 (Monthly)"
...
# Process all months from 2000-2004
