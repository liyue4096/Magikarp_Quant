...
# Historical backfill script: 2020-01 to 2025-11 (Monthly with cooldown)
# 
# Strategy:
...
#
# Usage: ./scripts/backfill-2020-2025-monthly.sh [environment]
...
echo "=========================================="
echo "Historical Backfill: 2020-01 to 2025-11"
...
echo "Total: 71 months (2020-01 to 2025-11)"
...
# Process months from 2020-01 to 2025-11
month_counter=0
total_months=71
...
for month in {1..12}; do
    ...
    process_month 2020 $month $api_key &
...
# 2021-2024: Full years (48 months)
...
# 2025: January to November (11 months)
for month in {1..11}; do
    api_key=$(( (month_counter % 5) + 1 ))
    process_month 2025 $month $api_key &
    month_counter=$((month_counter + 1))
